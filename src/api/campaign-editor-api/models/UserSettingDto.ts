...
export function UserSettingDtoFromJSON(json: any): UserSettingDto {
    return UserSettingDtoFromJSONTyped(json, false);
}

export function UserSettingDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserSettingDto {
...
export function UserSettingDtoToJSON(value?: UserSettingDto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
