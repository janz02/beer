...
export interface ArchiveWalletRequest {
...
export interface GetMyClaimedCouponsRequest {
    xRTDTransactionGuid?: string;
}
...
export class WalletApi extends runtime.BaseAPI {
     ...
     */
    async archiveWalletRaw(requestParameters: ArchiveWalletRequest): Promise<runtime.ApiResponse<void>> {
     ...
     * Archives all coupon codes
     */
    async archiveWallet(requestParameters: ArchiveWalletRequest): Promise<void> {
        await this.archiveWalletRaw(requestParameters);
    }
     ...
     */
    async getMyClaimedCouponsRaw(requestParameters: GetMyClaimedCouponsRequest): Promise<runtime.ApiResponse<Array<MyClaimedCouponVm>>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Returns claimed coupon codes
     */
    async getMyClaimedCoupons(requestParameters: GetMyClaimedCouponsRequest): Promise<Array<MyClaimedCouponVm>> {
        const response = await this.getMyClaimedCouponsRaw(requestParameters);
