...
export class SystemParametersApi extends runtime.BaseAPI {
     ...
     */
    async getSystemParameterKeysRaw(): Promise<runtime.ApiResponse<Array<string>>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Returns a list of all the system parameter keys
     */
    async getSystemParameterKeys(): Promise<Array<string>> {
        const response = await this.getSystemParameterKeysRaw();
        return await response.value();
    }
