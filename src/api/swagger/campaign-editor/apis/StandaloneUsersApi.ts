...
export interface GetUserExtensionInfoByPasswordChangeGuidRequest {
    guid: string;
}
...
export class StandaloneUsersApi extends runtime.BaseAPI {
    ...
    async reSendPasswordChangeLinkRaw(requestParameters: ReSendPasswordChangeLinkRequest): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/api/StandaloneUsers/ReSendPasswordChangeLink`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
    ...
    async reSendPasswordChangeLink(requestParameters: ReSendPasswordChangeLinkRequest): Promise<void> {
        await this.reSendPasswordChangeLinkRaw(requestParameters);
    }
