 ...
 * 
 * @export
 * @interface SegmentationQueryDto
 */
export interface SegmentationQueryDto {
    /**
     * 
     * @type {number}
     * @memberof SegmentationQueryDto
     */
    id?: number;
    /**
     * 
...
export function SegmentationQueryDtoFromJSON(json: any): SegmentationQueryDto {
    return SegmentationQueryDtoFromJSONTyped(json, false);
}

export function SegmentationQueryDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): SegmentationQueryDto {
...
export function SegmentationQueryDtoToJSON(value?: SegmentationQueryDto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
