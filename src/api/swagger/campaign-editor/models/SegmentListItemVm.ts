 ...
 * 
 * @export
 * @interface SegmentListItemVm
 */
export interface SegmentListItemVm {
    /**
     * 
     * @type {number}
     * @memberof SegmentListItemVm
     */
    id?: number;
    /**
     * 
...
export function SegmentListItemVmFromJSON(json: any): SegmentListItemVm {
    return SegmentListItemVmFromJSONTyped(json, false);
}

export function SegmentListItemVmFromJSONTyped(json: any, ignoreDiscriminator: boolean): SegmentListItemVm {
...
export function SegmentListItemVmToJSON(value?: SegmentListItemVm | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
