 ...
 * 
 * @export
 * @interface CreateUpdatePermissionCommand
 */
export interface CreateUpdatePermissionCommand {
    /**
     * Id of permission. Should only be used if the model is describing an already existing permission.
     * @type {number}
     * @memberof CreateUpdatePermissionCommand
     */
    id?: number;
    /**
...
export function CreateUpdatePermissionCommandFromJSON(json: any): CreateUpdatePermissionCommand {
    return CreateUpdatePermissionCommandFromJSONTyped(json, false);
}

export function CreateUpdatePermissionCommandFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateUpdatePermissionCommand {
...
export function CreateUpdatePermissionCommandToJSON(value?: CreateUpdatePermissionCommand | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
