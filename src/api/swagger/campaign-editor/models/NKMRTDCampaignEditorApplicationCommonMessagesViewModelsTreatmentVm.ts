...
import {
    NKMRTDCampaignEditorApplicationCommonMessagesViewModelsDiscountVm,
    NKMRTDCampaignEditorApplicationCommonMessagesViewModelsDiscountVmFromJSON,
    NKMRTDCampaignEditorApplicationCommonMessagesViewModelsDiscountVmFromJSONTyped,
    NKMRTDCampaignEditorApplicationCommonMessagesViewModelsDiscountVmToJSON,
    SystemTimeSpan,
 ...
 * 
 * @export
 * @interface NKMRTDCampaignEditorApplicationCommonMessagesViewModelsTreatmentVm
 */
export interface NKMRTDCampaignEditorApplicationCommonMessagesViewModelsTreatmentVm {
    /**
     * 
     * @type {number}
     * @memberof NKMRTDCampaignEditorApplicationCommonMessagesViewModelsTreatmentVm
     */
    id?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<NKMRTDCampaignEditorApplicationCommonMessagesViewModelsDiscountVm>}
     * @memberof NKMRTDCampaignEditorApplicationCommonMessagesViewModelsTreatmentVm
     */
    discounts?: Array<NKMRTDCampaignEditorApplicationCommonMessagesViewModelsDiscountVm> | null;
}

export function NKMRTDCampaignEditorApplicationCommonMessagesViewModelsTreatmentVmFromJSON(json: any): NKMRTDCampaignEditorApplicationCommonMessagesViewModelsTreatmentVm {
    return NKMRTDCampaignEditorApplicationCommonMessagesViewModelsTreatmentVmFromJSONTyped(json, false);
}

export function NKMRTDCampaignEditorApplicationCommonMessagesViewModelsTreatmentVmFromJSONTyped(json: any, ignoreDiscriminator: boolean): NKMRTDCampaignEditorApplicationCommonMessagesViewModelsTreatmentVm {
    ...
    return {
        ...
        'discounts': !exists(json, 'discounts') ? undefined : (json['discounts'] === null ? null : (json['discounts'] as Array<any>).map(NKMRTDCampaignEditorApplicationCommonMessagesViewModelsDiscountVmFromJSON)),
    };
}

export function NKMRTDCampaignEditorApplicationCommonMessagesViewModelsTreatmentVmToJSON(value?: NKMRTDCampaignEditorApplicationCommonMessagesViewModelsTreatmentVm | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'discounts': value.discounts === undefined ? undefined : (value.discounts === null ? null : (value.discounts as Array<any>).map(NKMRTDCampaignEditorApplicationCommonMessagesViewModelsDiscountVmToJSON)),
    };
}
