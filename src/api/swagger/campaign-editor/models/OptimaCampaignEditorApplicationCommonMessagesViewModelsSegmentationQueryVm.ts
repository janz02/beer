 ...
 * 
 * @export
 * @interface OptimaCampaignEditorApplicationCommonMessagesViewModelsSegmentationQueryVm
 */
export interface OptimaCampaignEditorApplicationCommonMessagesViewModelsSegmentationQueryVm {
    /**
     * 
     * @type {number}
     * @memberof OptimaCampaignEditorApplicationCommonMessagesViewModelsSegmentationQueryVm
     */
    id?: number;
    /**
     * 
...
export function OptimaCampaignEditorApplicationCommonMessagesViewModelsSegmentationQueryVmFromJSON(json: any): OptimaCampaignEditorApplicationCommonMessagesViewModelsSegmentationQueryVm {
    return OptimaCampaignEditorApplicationCommonMessagesViewModelsSegmentationQueryVmFromJSONTyped(json, false);
}

export function OptimaCampaignEditorApplicationCommonMessagesViewModelsSegmentationQueryVmFromJSONTyped(json: any, ignoreDiscriminator: boolean): OptimaCampaignEditorApplicationCommonMessagesViewModelsSegmentationQueryVm {
...
export function OptimaCampaignEditorApplicationCommonMessagesViewModelsSegmentationQueryVmToJSON(value?: OptimaCampaignEditorApplicationCommonMessagesViewModelsSegmentationQueryVm | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
