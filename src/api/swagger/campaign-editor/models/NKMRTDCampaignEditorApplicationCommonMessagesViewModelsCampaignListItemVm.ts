 ...
 * 
 * @export
 * @interface NKMRTDCampaignEditorApplicationCommonMessagesViewModelsCampaignListItemVm
 */
export interface NKMRTDCampaignEditorApplicationCommonMessagesViewModelsCampaignListItemVm {
    /**
     * 
     * @type {number}
     * @memberof NKMRTDCampaignEditorApplicationCommonMessagesViewModelsCampaignListItemVm
     */
    id?: number;
    /**
     * 
...
export function NKMRTDCampaignEditorApplicationCommonMessagesViewModelsCampaignListItemVmFromJSON(json: any): NKMRTDCampaignEditorApplicationCommonMessagesViewModelsCampaignListItemVm {
    return NKMRTDCampaignEditorApplicationCommonMessagesViewModelsCampaignListItemVmFromJSONTyped(json, false);
}

export function NKMRTDCampaignEditorApplicationCommonMessagesViewModelsCampaignListItemVmFromJSONTyped(json: any, ignoreDiscriminator: boolean): NKMRTDCampaignEditorApplicationCommonMessagesViewModelsCampaignListItemVm {
...
export function NKMRTDCampaignEditorApplicationCommonMessagesViewModelsCampaignListItemVmToJSON(value?: NKMRTDCampaignEditorApplicationCommonMessagesViewModelsCampaignListItemVm | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
