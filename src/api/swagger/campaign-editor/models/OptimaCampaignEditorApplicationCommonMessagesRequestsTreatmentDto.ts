...
import {
    OptimaCampaignEditorApplicationCommonMessagesRequestsDiscountDto,
    OptimaCampaignEditorApplicationCommonMessagesRequestsDiscountDtoFromJSON,
    OptimaCampaignEditorApplicationCommonMessagesRequestsDiscountDtoFromJSONTyped,
    OptimaCampaignEditorApplicationCommonMessagesRequestsDiscountDtoToJSON,
    SystemTimeSpan,
 ...
 * 
 * @export
 * @interface OptimaCampaignEditorApplicationCommonMessagesRequestsTreatmentDto
 */
export interface OptimaCampaignEditorApplicationCommonMessagesRequestsTreatmentDto {
    /**
     * 
     * @type {number}
     * @memberof OptimaCampaignEditorApplicationCommonMessagesRequestsTreatmentDto
     */
    id?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<OptimaCampaignEditorApplicationCommonMessagesRequestsDiscountDto>}
     * @memberof OptimaCampaignEditorApplicationCommonMessagesRequestsTreatmentDto
     */
    discounts?: Array<OptimaCampaignEditorApplicationCommonMessagesRequestsDiscountDto> | null;
}

export function OptimaCampaignEditorApplicationCommonMessagesRequestsTreatmentDtoFromJSON(json: any): OptimaCampaignEditorApplicationCommonMessagesRequestsTreatmentDto {
    return OptimaCampaignEditorApplicationCommonMessagesRequestsTreatmentDtoFromJSONTyped(json, false);
}

export function OptimaCampaignEditorApplicationCommonMessagesRequestsTreatmentDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): OptimaCampaignEditorApplicationCommonMessagesRequestsTreatmentDto {
    ...
    return {
        ...
        'discounts': !exists(json, 'discounts') ? undefined : (json['discounts'] === null ? null : (json['discounts'] as Array<any>).map(OptimaCampaignEditorApplicationCommonMessagesRequestsDiscountDtoFromJSON)),
    };
}

export function OptimaCampaignEditorApplicationCommonMessagesRequestsTreatmentDtoToJSON(value?: OptimaCampaignEditorApplicationCommonMessagesRequestsTreatmentDto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'discounts': value.discounts === undefined ? undefined : (value.discounts === null ? null : (value.discounts as Array<any>).map(OptimaCampaignEditorApplicationCommonMessagesRequestsDiscountDtoToJSON)),
    };
}
