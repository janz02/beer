 ...
 * 
 * @export
 * @interface NKMRTDApplicationModelsViewModelsCampaignListItemVm
 */
export interface NKMRTDApplicationModelsViewModelsCampaignListItemVm {
    /**
     * 
     * @type {number}
     * @memberof NKMRTDApplicationModelsViewModelsCampaignListItemVm
     */
    id?: number;
    /**
     * 
...
export function NKMRTDApplicationModelsViewModelsCampaignListItemVmFromJSON(json: any): NKMRTDApplicationModelsViewModelsCampaignListItemVm {
    return NKMRTDApplicationModelsViewModelsCampaignListItemVmFromJSONTyped(json, false);
}

export function NKMRTDApplicationModelsViewModelsCampaignListItemVmFromJSONTyped(json: any, ignoreDiscriminator: boolean): NKMRTDApplicationModelsViewModelsCampaignListItemVm {
...
export function NKMRTDApplicationModelsViewModelsCampaignListItemVmToJSON(value?: NKMRTDApplicationModelsViewModelsCampaignListItemVm | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
