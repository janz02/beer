...
export function UserSettingsVmFromJSON(json: any): UserSettingsVm {
    return UserSettingsVmFromJSONTyped(json, false);
}

export function UserSettingsVmFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserSettingsVm {
...
export function UserSettingsVmToJSON(value?: UserSettingsVm | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
