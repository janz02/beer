...
export interface NewsletterEditorUtilsProps {
...
interface NewsletterEditorUtils {
  getEditorContent: () => any
  isLatestTemplate: boolean
  isNewTemplate: boolean
}

export const useNewsletterEditorUtils = (
  props: NewsletterEditorUtilsProps
): NewsletterEditorUtils => {
