...
interface UseCampaignCategoryEditorProps {
  params: Pick<GenericModalFormEditorParams, 'id'>
  handleExit: () => void
  afterClose: () => void
}
interface UseCampaignCategoryEditorUtils {
  loading: boolean
...
export const useCampaignCategoryEditor = (
  props: UseCampaignCategoryEditorProps
): UseCampaignCategoryEditorUtils => {
