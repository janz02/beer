...
interface SegmentationCategoryEditorProps {
  params: GenericModalFormEditorParams
  handleExit: () => void
  afterClose: () => void
}

export const SegmentationCategoryEditor: FC<SegmentationCategoryEditorProps> = props => {
  ...
  const modalTitle = isNew
    ? t('segmentation-category.editor-create')
    : t('segmentation-category.editor-edit')
  ...
  return (
    <GenericModalForm
      ...
      formProps={{
        name: 'segmentation-category-editor',
        onFinish: handleSave
      }}
      initialValues={initialValues}
    >
      <Form.Item
        label={t('segmentation-category.field.name')}
        name="name"
        rules={[
