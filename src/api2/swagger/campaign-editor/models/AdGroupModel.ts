...
export function AdGroupModelFromJSON(json: any): AdGroupModel {
    return AdGroupModelFromJSONTyped(json, false);
}

export function AdGroupModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdGroupModel {
...
export function AdGroupModelToJSON(value?: AdGroupModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
