...
import { CouponCampaignStateDisplay } from './CouponCampaignStateDisplay'
import { CouponState } from 'api/swagger/coupon'

describe('CouponCampaignStateDisplay tests', () => {
  it('should render accepted state', () => {
    // Arrange
    const state = CouponState.Accepted

    // Act
    const wrapper = render(<CouponCampaignStateDisplay state={state} />)
